# =================================================================
# Windows ASEP Check - HKLM Run Keys (Readable Console Output)
# =================================================================
...
# --- Output control ---
# Option 1: Full console output (no truncation)
$results | Format-List

# Option 2: Export to CSV for Excel
# $results | Export-Csv -Path ".\ASEP_HKLM_RunKeys_Details.csv" -NoTypeInformation

# SIG # Begin signature block
# MIII1QYJKoZIhvcNAQcCoIIIxjCCCMICAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU6mxWqrXVL8pwnb84h2Z880zm
# gJigggYoMIIGJDCCBQygAwIBAgITEwAAAOoKFpTrnDcwtAAEAAAA6jANBgkqhkiG
...
# BBSjo6eP9Pg6fYqJqnzVXYSFsaqR0zANBgkqhkiG9w0BAQEFAASCAQAm+H58Sqjo
# xy1FWk5qAZelJ3z9zWnvc9CTxC+PiBwlG6apcb/98nJqG1Bq2+WOgj1aVWHZLeRP
# 3rHDkKjQVMlJnCDFp2wuiT6xnwct+HZFZ/cP9pUnmw8eZv6DZ9PsaJqo2JskcQnb
# yf2ql5ogJv2X47HVt4yiEKSVcTxQ2KzXqGEGhQ0ccNUtglH8gLr4Gs2zBgY/TfL9
# am+SBWEzsr1aHJc9gBCoPgsAXHa7qowvV65TCXi+bndK3VSPMnvNv+vD02hATJrB
# Uk5cgKTOk59dJw2o8n4h1bQ5hOixcIixk2pSVGnbL93F3Z58cSlQeiC7lqIomkGE
# EhT/tCH1AQ8A
